...
export const siteConfig = {
  ...
  description: 'Portfolio of Spandan Mozumder',
  url: process.env.NEXT_PUBLIC_URL || 'http://localhost:3000',
  author: {
    name: about.name,
    twitter: '@spandanmozumder',
    github: 'spandan-mozumder',
    linkedin: 'spandan-mozumder',
    email: 'spandan.mozumder.professional@gmail.com',
  },
  keywords: [
    'portfolio',
    'developer',
...
export function generateMetadata(pathname: string) {
  ...
  const ogImageUrl = `${siteConfig.url}${
    pageMeta.ogImage || '/assets/logo.png'
  }`;
