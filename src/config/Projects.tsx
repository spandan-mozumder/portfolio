...
export const projects: Project[] = [
  ...
  },
  {
    ...
    features: [
      'Natural‑language component generation with live preview',
      'Production‑ready shadcn/ui components',
      'File explorer, syntax highlighting, instant feedback',
      'Multi‑project, version history, mobile‑first output',
      'OKLch color system, dark/light mode, accessible components',
      'Sandboxed execution with E2B, chat persistence',
      'Background jobs via Inngest, type‑safe stack',
    ],
  ...
  },
  {
    ...
    features: [
      'WhatsApp bulk messaging via WhatsApp Web, QR auth, emoji support',
      'Real‑time delivery tracking with retries and Indian number auto‑format',
      '500 emails/day via Gmail SMTP, multi‑provider support, smart batching',
      'Excel import, mapping, validation, templates and logs',
      'Multi‑day scheduling, pause/resume, progress dashboard',
      'Secure auth, protected routes, responsive UI with smooth animations',
    ],
