...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card className="group h-full w-full overflow-hidden transition-all p-4 border-gray-100 dark:border-gray-800 shadow-none hover:shadow-md hover:border-gray-200 dark:hover:border-gray-700">
